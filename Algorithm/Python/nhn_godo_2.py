...
# 문제에서는 원하는 페이지 번호 page과 고장난 숫자 버튼들 정수 배열 broken이 주어진다. 원하는 페이지로 가기 위해서 버튼을 눌러야 하는 최소한의 횟수를 리턴하시오.
...
# page = 5457
# broken = [6,7,8]리턴(정답): 6
# 5457로 가기 위해 "5 4 5 5 + +" 를 누르거나 "5 4 5 9 - -"를 누를 수 있다.

# page = 100
# broken = [1,0,5]리턴(정답): 0
# 처음 시작하는 페이지가 100이므로 아무것도 누르지 않아도 된다.

# page = 99999
# broken = [0,2,3,4,5,6,7,8,9]리턴(정답): 11118
# page = 158
# broken = [1,9,2,5,4]리턴(정답): 58
# page = 151241
# broken = [0,1,2,3,4,7,8,9]리턴(정답): 84580
...
sun_btn = [x for x in button if x not in broken]
# [0, 1, 2, 3, 4, 5, 9]
arr_page = (list(map(int, str(page))))
# [5, 4, 5, 7]
